...
* TODO: working/combatShip list counter functionality
*	Fleet name
...
*       - helper method for filtered list of working/fighterShips
*********************************************/
public class Fleet {
	/**********CONSTANTS***********/
	private String name;
	...
	*/
	...
	/********* HELPER METHODS *********/
    /**
	* Uses polymorphism to create a filted ArrayList of WorkingShips
	*
	* @return list of workingShips
	*/
	public List<WorkingShip> getWorkingShips() {
		List<WorkingShip> workingShips = new ArrayList<>();
		for (Ship ship : ships) {
			if (ship instanceof WorkingShip workingShip) {
				workingShips.add(workingShip);
			}
		}
		return workingShips;
	}
    /**
	* Uses polymorphism to create a filted ArrayList of FighterShip
	*
	* @return list of fighterShips
	*/
	public List<FighterShip> getCombatShips() {
		List<FighterShip> fighterShips = new ArrayList<>();
		for (Ship ship : ships) {
			if (ship instanceof FighterShip fighterShip) {
				fighterShips.add(fighterShip);
			}
		}
		return fighterShips;
	}
